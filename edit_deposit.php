...
$anm_id = $_GET['anm_id'];
    ...
    $sql = "SELECT * FROM animal_deposit WHERE anm_id = $anm_id";
...
<head>
    ...
    <title>หน้าแก้ไขข้อมูลการฝาก-รับ</title>
</head>
<body>
<form action="data_deposit.php" method="post">
<div class="container mt-3">
  <h2>หน้าแก้ไขข้อมูลการฝาก-รับ</h2>
  <p>//////////////////////////////////////////////</p>
  ...
  <div class="input-group mb-3">
    ...
    <input type="text" class="form-control" name="edit_anm_deposit_date" required value="<?php echo $result['anm_deposit_date']?>">
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text">เวลาฝาก</span>
    <input type="text" class="form-control" name="edit_anm_Deposit_time" required value="<?php echo $result['anm_Deposit_time']?>">
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text">วันที่รับ</span>
    <input type="text" class="form-control" name="edit_anm_pick_up_date" required value="<?php echo $result['anm_pick_up_date']?>">
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text">เวลารับ</span>
    <input type="text" class="form-control" name="edit_anm_pick_up_time" required value="<?php echo $result['anm_pick_up_time']?>">
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text">จำนวนวัน</span>
    <input type="text" class="form-control" name="edit_anm_day" required value="<?php echo $result['anm_day']?>">
  </div>
